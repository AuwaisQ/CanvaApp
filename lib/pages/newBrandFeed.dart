...
class NewBrandFeed extends StatefulWidget {
  String? categoryId;
  String? displayImage;
  NewBrandFeed({required this.categoryId, this.displayImage});
  @override
  _NewBrandFeedState createState() =>
      _NewBrandFeedState(categoryId, displayImage.toString());
}

class _NewBrandFeedState extends State<NewBrandFeed>with SingleTickerProviderStateMixin {
